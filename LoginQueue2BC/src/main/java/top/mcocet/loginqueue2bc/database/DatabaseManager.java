package top.mcocet.loginqueue2bc.database;
...
public class DatabaseManager {
    ...
    public DatabaseManager(LoginQueue2BC plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean isIpBanned(String ip) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                long banDuration = plugin.getConfig().getLong("ip-ban-duration", 86400000);
    ...
    public int getAuthFailureCount(String ip) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                long resetDuration = plugin.getConfig().getLong("auth-failure-reset-duration", 3600000);
